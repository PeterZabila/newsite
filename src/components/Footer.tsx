...
<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 border-b-[1px] border-slate-400 border-opacity-80 mr-[20px] mb-[20px]'>
    ...
    <div>
        <img src={logoBlack} alt="logo footer" className='w-[120px] h-[60px] mb-[50px] hover:scale-110 transition-all duration-500' onClick={() => navigate("/")}/>
    ...
    <div>
        <ul>
            {categories.map((category: string) => <li key={category} className='mb-[15px] text-xl htransition-transform duration-300 transform hover:scale-105'
